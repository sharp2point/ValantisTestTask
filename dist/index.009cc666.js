...
})({"7Wm4G":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f46314e3009cc666";
"use strict";
...
},{}],"avHVc":[function(require,module,exports) {
    ...
    connectedCallback() {
        this.root.querySelectorAll(".clear-button").forEach((inp)=>{
            inp.addEventListener("click", (e)=>{
                ...
                switch(e.target.dataset["name"]){
                    case "product":
                        this.root.getElementById("product").value = "";
                        break;
                    case "brand":
                        this.root.getElementById("brand").value = "";
                        break;
                    case "price":
                        this.root.getElementById("price").value = "";
                        break;
                }
            });
        });
        ...
        this.dom.inputs.forEach((inp)=>{
            inp.addEventListener("keydown", (e)=>{
                if (e.key === "Enter") this.onSubmit(this.dom.form);
            });
        });
    }
    onSubmit = (form)=>{
...
if (!customElements.get("nice2jm-filter")) customElements.define("nice2jm-filter", FilterComponent);
//-----------------------------------------------
function renderTemplate() {
    const html = `
            ...
            <form id="filter-form" action="">
                <div class="frame">
                    <label for="product">\u{41D}\u{430}\u{437}\u{432}\u{430}\u{43D}\u{438}\u{435} \u{43F}\u{440}\u{43E}\u{434}\u{443}\u{43A}\u{442}\u{430}:</label>
                    <div class="block">
                ...
                <div class="frame">
                    <label for="brand">\u{411}\u{440}\u{435}\u{43D}\u{434}:</label>
                    <div class="block">
                ...
                <div class="frame">
                    <label for="price">\u{426}\u{435}\u{43D}\u{430}:</label>
                    <div class="block">
                        <input type="text" name="price" id="price" pattern="[0-9]{1,9}" title="\u{432}\u{43E}\u{432}\u{43E}\u{434}\u{438}\u{442}\u{435} \u{442}\u{43E}\u{43B}\u{44C}\u{43A}\u{43E} \u{447}\u{438}\u{441}\u{43B}\u{430}">
...
},{}]},["7Wm4G","avHVc"], "avHVc", "parcelRequire1910")

//# sourceMappingURL=index.009cc666.js.map
